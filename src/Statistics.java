...
public class Statistics {
    ...
    public Statistics(Program program) {
        this.visualizer = new Visualizer(program);
    }

    public String nameFile() {
        return this.visualizer.getNameFile();
    }
    ...
    public void showData(String tspFile, Environment environment, double[][] coordinates) {
        this.environment = environment;
        this.visualizer.asignData(coordinates);
        this.visualizer.createData();
...
//        this.visualizer.getContentPane().removeAll();
